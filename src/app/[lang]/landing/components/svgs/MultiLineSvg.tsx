const MultiLineSvg = ({ color , dir } : any) => {
	// Convert hex to RGB and normalize (0-255 range -> 0-1 range)
	const hexToNormalizedRGB = (hex : any) => {
	...
	return (
		<svg
		    className={`${dir === 'ltr' ? 'rotate-0' : 'rotate-180'} `}
			width="87"
			height="485"
			viewBox="0 0 87 485"
			fill="none"
